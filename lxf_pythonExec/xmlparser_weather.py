    ...
    def start_element(self, name, attrs):
        ...
        if weather_match:
            ...
            # 检查日期
                ...
                #{'xmlns:yweather': 'http://xml.weather.yahoo.com/ns/rss/1.0', 'code': '32',
                #           'date': 'Thu, 30 Nov 2017 04:00 PM CST', 'temp': '39', 'text': 'Sunny'}
            ...
            # 检查天气
                ...
                # 创建二级字典
                # attrs = {'xmlns:yweather': 'http://xml.weather.yahoo.com/ns/rss/1.0', 'code': '32',
                #          'date': '30 Nov 2017', 'day': 'Thu', 'high': '39', 'low': '17', 'text': 'Sunny'}
                attr = dict()
